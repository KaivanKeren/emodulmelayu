...
Route::middleware('auth')->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/users/filter', [UserController::class, 'filter'])->name('users.page.filter');
        Route::get('/assessments/filter', [AssessmentController::class, 'filter'])->name('assessments.filter');
        ...
        Route::prefix('users')->group(function () {
            ...
            Route::post('/bulk-accept', [UserController::class, 'bulkAccept'])->name('users.bulk-accept');
            Route::post('/accept-all', [UserController::class, 'acceptAll'])->name('users.accept-all');
