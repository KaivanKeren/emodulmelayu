                        ...
                        <div class="rounded-md">
                            <div
                                ...
                                <select name="status" id="status"
                                    class="block w-full pl-2 bg-transparent border-0 focus:ring-0 focus:outline-none">
                                    <option value="belum terbuka" {{ old('status') == 'belum terbuka' ? 'selected' : '' }}>
                                        Belum Terbuka</option>
                                    <option value="terbuka" {{ old('status') == 'terbuka' ? 'selected' : '' }}>Terbuka
                                    </option>
                                    <option value="terjawab" {{ old('status') == 'terjawab' ? 'selected' : '' }}>Terjawab
                                    </option>
