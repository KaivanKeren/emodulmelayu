                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        @forelse ($assessment->questions as $index => $question)
                            <div
                                class="bg-gray-50 rounded-lg p-6 border border-gray-100 hover:border-orange-200 transition-colors">
                                        ...
                                        <div class="space-y-3 ml-4">
                                            @foreach ($question->options as $optionIndex => $option)
                                                <div class="flex items-center gap-3 text-gray-700">
                                                    <span
                                                        class="text-sm text-gray-500 w-6">{{ chr(65 + $optionIndex) }}.</span>
