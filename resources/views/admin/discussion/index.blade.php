                ...
                <div class="flex justify-between gap-2 items-center">
                    @auth
                        ...
                        <a href="{{ route('filter-message.index') }}"
                            class="inline-flex text-xs items-center px-4 py-2 uppercase tracking-widest text-gray-600 bg-gray-200 rounded-lg hover:bg-gray-300 border border-gray-300">
                            Filter Pesan
                        </a>
                    </div>
                @endauth
