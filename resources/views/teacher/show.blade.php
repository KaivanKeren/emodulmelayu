                        ...
                        <div class="space-y-6">
                            ...
                            @if ($assessment->status === 'Terbuka')
                                <div class="space-y-4">
                                            ...
                                            @if ($assessment->token && $assessment->token_expires_at && now()->lt($assessment->token_expires_at))
                                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 relative">
                                                    ...
                                                    <div class="text-xs text-gray-500 mt-2">
                                                        ...
                                                        <span id="expires-at">
                                                            {{ $assessment->token_expires_at ? $assessment->token_expires_at->setTimezone('Asia/Jakarta')->format('H:i') : '-' }}
                                    ...
                                    <form action="{{ route('teacher.assessments.regenerate-token', $assessment) }}"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if ($respondentCount > 0)
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('teacher.answers.show', $assessment->id) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const expiresAtString =
                "{{ $assessment->token_expires_at ? $assessment->token_expires_at->setTimezone('Asia/Jakarta') : '' }}";
            const expiresAt = expiresAtString ? new Date(expiresAtString).getTime() : null;
